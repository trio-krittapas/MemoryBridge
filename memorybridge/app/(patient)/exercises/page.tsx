...
export default function ExerciseSelectionPage() {
  ...
  return (
    <div className="container max-w-lg py-10 space-y-8 animate-in fade-in duration-500">
          ...
          <Link href={ex.href} key={ex.id}>
            <Card className="hover:shadow-2xl transition-all border-2 active:scale-95 group rounded-[2.5rem] overflow-hidden">
              <CardContent className="p-0 flex h-32">
                <div className={`${ex.color} w-32 flex items-center justify-center`}>
                  <ex.icon className="h-12 w-12 text-white" />
                </div>
